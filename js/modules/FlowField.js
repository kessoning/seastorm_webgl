 ...
 */
 ...
 // Three.js stuff
import { DataTexture, RGBFormat, FloatType, NearestFilter, Vector2 } from '../../libs/three.module.js';

// Perlin Noise
import { ImprovedNoise } from '../../libs/ImprovedNoise.js';

import { PI, TWO_PI } from './utils/math.js';
    ...
    this.update = function () {
        ...
        for (let i = 0; i < this.cols; i++) {
            ...
            for (let y = 0; y < this.rows; y++) {
                ...
                let n = PI + ((1.0 + this.perlin.noise(this.noise[nindex].x, this.noise[nindex].y, this.zoff)) / 2) * TWO_PI;
